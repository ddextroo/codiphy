...
const menuItems = [
  {
    ...
    image: <img src={Image} className="w-80 h-72" />,
  ...
  },
  {
    ...
    image: <img src={Image1} className="w-80 h-72" />,
  ...
  },
  {
    ...
    image: <img src={Image2} className="w-80 h-72" />,
  ...
  },
  {
    ...
    image: <img src={Image3} className="w-80 h-72" />,
  ...
  },
  {
    ...
    image: <img src={Image4} className="w-80 h-72" />,
          ...
          {menuItems.map((menu, index) => (
            <SplideSlide>
              <div className="grid grid-cols-2 gap-2 md:grid-cols-2 place-items-center">
                <div className="h-90 rounded-md md:mt-3 md:ml-3 md:mr-3  md:mb-3 flex flex-col items-center justify-center">
                  ...
                  <div className="text-primaryDark md:mt-5 md:ml-10 md:mr-5 text-md md:text-lg px-5 text-justify">
                    {menu.description}
                  </div>
                </div>
{/* dds */}
