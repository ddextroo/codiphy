...
function hero() {
  ...
  return (
    <section id="hero" className="bg-opacity-0">
      ...
      <div className="flex flex-col justify-end max-h-full md:mt-52 md:h-fit lg:h-screen">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="flex flex-row space-x-3 mt-5 mb-5 bg-opacity-0">
          ...
          <img src={Preview} className="w-auto h-72 bg-opacity-0"></img>
        </div>
        <Outlet />
      </div>
