  ...
  return (
    <nav>
      <div className="flex flex-row justify-between space-x-5">
        ...
        <div className={`hidden justify-center space-x-5 md:flex md:flex-row items-end ${isOpen ? 'block flex-col' : 'block'}`}>
        ...
        <div className="visible md:invisible" onClick={toggleMenu}>
          <Hamburger
            size={20}
            color="#3a3a3a"
            toggled={isOpen}
