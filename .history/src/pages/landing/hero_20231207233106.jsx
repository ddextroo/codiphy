    ...
    <div className="min-h-screen max-h-full flex flex-col justify-end ">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-row space-x-3 mt-5 mb-5">
          ...
          <div className="rounded-lg bg-primaryLight text-primaryDark border border-solid border-gray px-5 py-2 font-semibold cursor-pointer hover:bg-colorAccent text-primaryLight">
            Try Demo
          </div>
        </div>
