    ...
    <nav>
      <div className="flex flex-row justify-between space-x-5 ">
        ...
        <div className="items-center flex flex-row md:w-full">
          <div className="visible absolute md:invisible">
            <Hamburger
              size={20}
              color="#3a3a3a"
              toggled={isOpen}
            ...
            />
            <div
              className={`justify-center bg-red-500 md:flex md:flex-row md:space-x-5 md:w-full ${
                isOpen ? "flex flex-col" : "md:flex md:flex-col"
              }`}
            >
