      ...
      <div className="flex flex-col justify-end max-h-full md:mt-52 md:h-fit lg:h-screen">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="flex flex-row space-x-3 mt-5 mb-5">
            ...
            <div className="rounded-lg bg-primaryLight text-primaryDark border border-solid border-gray px-5 py-2 font-semibold cursor-pointer hover:bg-gray hover:bg-opacity-10 hover:text-primaryLight bg-transparent">
