...
function Nav() {
  ...
  return (
    <nav className={`sticky top-0 p-3 ${isSticky ? 'bg-primaryLight shadow-lg rounded-b-lg' : ''}`}>
          ...
          <div className="">
            ...
            <div
              className={`justify-center flex-col  md:flex md:flex-row md:space-x-5 md:mt-2 md:w-full ${
                isOpen ? "space-y-5 md:space-y-0 p-10 bg-primaryLight shadow-lg rounded-b-lg md:p-0 md:bg-opacity-0 md:shadow-transparent" : "hidden p-0 space-y-0"
              }`}
            >
