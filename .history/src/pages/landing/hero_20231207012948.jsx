    ...
    <div>
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-row space-x-3">
          <div className="rounded-lg bg-colorAccent text-primaryLight px-5 py-2 font-semibold cursor-pointer">Get Started</div>
          <div className="rounded-lg bg-primaryLight text-primaryDark border border-solid px-5 py-2 font-semibold cursor-pointer">Get Started</div>
        </div>
      </div>
    </div>
  );
