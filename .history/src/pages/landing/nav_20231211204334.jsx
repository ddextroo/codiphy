...
function Nav() {
  ...
  return (
    <nav>
      <div className="flex flex-row justify-between space-x-5 md:px-5 bg-red-600">
        <div className="font-bold flex flex-row items-end justify-end gap-3 mt-2 md:mt-0">
          <img src={Logo} className="w-7 h-7"></img>
          Codiphy
        </div>
        <div className="flex flex-row absolute right-10 md:w-full md:justify-center md:relative ">
          <div className="">
            ...
            <div
              className={`justify-center flex-col  md:flex md:flex-row md:space-x-5 md:mb-2 md:w-full ${
